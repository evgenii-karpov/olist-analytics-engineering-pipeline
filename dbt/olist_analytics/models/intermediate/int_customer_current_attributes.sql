...
select
    ...
    coalesce(latest_corrections.customer_zip_code_prefix, base_customers.customer_zip_code_prefix) as customer_zip_code_prefix,
    ...
    greatest(base_customers._loaded_at, coalesce(latest_corrections._loaded_at, base_customers._loaded_at)) as _loaded_at
from base_customers
